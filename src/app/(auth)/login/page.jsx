                ...
                <div className="mx-auto w-full max-w-sm">
                    ...
                    <form className="mt-10 space-y-5" onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            className="flex w-full justify-center rounded-xl bg-blue-600 px-4 py-4 text-sm font-bold text-white shadow-lg shadow-blue-100 hover:bg-blue-700 active:scale-[0.98] transition-all duration-200 disabled:opacity-70"
                        >
            ...
            <div className="relative hidden w-0 flex-1 lg:block overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-950/80 via-transparent to-transparent flex flex-col justify-end p-20 animate-in fade-in slide-in-from-bottom duration-1000 delay-300">
                    <div className="max-w-md text-white">
                        <h3 className="text-4xl font-bold leading-tight">Fastest delivery, <br/> Guaranteed quality.</h3>
                        <p className="mt-4 text-blue-100/80 text-lg">Join 10,000+ families getting fresh groceries delivered daily.</p>
                    </div>
                </div>
            </div>
        </div>
